---
name: chatbot
description: CHATBOT -- Lightweight Interactive Agent
---
...
2. **Skill invocation** -- load and follow any skill in .ai/skills/
...
- Cache START_HERE.md and GUIDE.md after first read (they change infrequently)
