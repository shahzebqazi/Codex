...
- **Documentation**: Link to HF docs for model cards, datasets, and best practices; keep references in Project/Product/References/URLS.md.
...
- **Project/Product/References/URLS.md**: Central list of HF docs and leaderboard URLs.
