...
These are the system-wide defaults for agent behavior. Project-specific overrides go in `MENTAL_MAP.md`. User-specific private overrides go in `config/local/MEMORIES.md`.
